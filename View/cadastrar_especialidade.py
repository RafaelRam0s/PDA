...
def cadastrar_Especialidade(nome):
    Especialidade.adicionar_especialidade(nome)
btn_cadastrar_especialidade = Button(cadastrar_especialidade, text="Cadastrar Especialidade", command=lambda: cadastrar_Especialidade(text_nome.get())).pack()
